...
1. Upload the plugin files to the `/wp-content/plugins/ft-core-block-domaincheck` directory, or install the plugin through the WordPress plugins screen directly.
...
1. Animation of block in action.
